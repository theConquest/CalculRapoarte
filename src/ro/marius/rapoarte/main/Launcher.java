...
public class Launcher {
	...
	public static void setOra(String ora1) {
		ora = ora1;
	}
	...
	public static void setPos1(String p1) {
		pos1 = p1;
	}
	...
	public static void setPos2(String p2) {
		pos2 = p2;
	}

	public static String getPos2() {
		return pos2;
	}
	...
	public static void main(String[] args) {
		// Instantiaza butoane, Instantiaza listeneri, adauga listeneri la
		// butoane
		// Instantiaza text field
		// Instantiaza text label
		// Instantiaza JFrame, adauga tot ce e mai sus la el si gata;
		JLabel oraLabel = new JLabel("introduceti intervalul orar, ex: 07-08:",
				JLabel.CENTER);
		oraLabel.setSize(300, 30);
		oraLabel.setLocation(5, 5);

		JLabel POSLabel = new JLabel(
				"Introduceti raportul pentru POS1 si POS2, ex 875 sau 150.87:",
				JLabel.CENTER);
